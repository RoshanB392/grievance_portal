...
from flaskApp.form import RegistrationForm, LoginForm, UpdateAccountForm, PostGrievanceForm, RequestResetForm, ResetPasswordForm
...
def send_reset_email(user):
    ...
    msg = Message(subject='Password Reset Request',
                  sender='noreply@grievanceportal.com',
